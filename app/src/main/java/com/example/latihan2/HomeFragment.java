...
public class HomeFragment extends Fragment implements SelectListen {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_list_makanan, container, false);

        RecyclerView recyclerView = rootView.findViewById(R.id.recycl);
        List<myItems> Barang = new ArrayList<>();
        ...
        recyclerView.setAdapter(new adaptor(getActivity(), Barang, this));
    ...
    public void itemklik(myItems holding) {
        Toast.makeText(getActivity(), holding.getName(), Toast.LENGTH_SHORT).show();
    }
}
